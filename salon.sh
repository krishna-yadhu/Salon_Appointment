...
case $SERVICE_ID_SELECTED in
  ...
  2) NEXT ;;
  3) NEXT ;;
  *) GET_SERVICES_ID "I could not find service. What you like today?" ;;
esac
}
...
NEXT(){
  ...
  read SERVICE_TIME
  SAVED_TO_TABLE_APPOINMENTS=$($PSQL "INSERT INTO appointments(customer_id, service_id, time) VALUES ($CUSTOMER_ID, $SERVICE_ID_SELECTED, '$SERVICE_TIME')")
  if [[ $SAVED_TO_TABLE_APPOINMENTS == "INSERT 0 1" ]]
  then
